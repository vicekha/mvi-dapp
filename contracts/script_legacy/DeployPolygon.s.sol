...
contract DeployPolygonScript is Script {
    ...
    // Hyperlane Mailbox on Amoy
    // https://docs.hyperlane.xyz/docs/reference/contract-addresses#polygon-amoy
    address constant AMOY_MAILBOX = 0x17DEd59Fcd940d0a4E9c34584C2eD53519e446B7; // Update if changed
    ...
    function run() public {
        ...
        // Use env vars if set, otherwise use defaults for Amoy
        address mailbox = vm.envOr("HYPERLANE_MAILBOX", AMOY_MAILBOX);
        uint256 bridgeFee = vm.envOr("BRIDGE_FEE_PERCENTAGE", DEFAULT_BRIDGE_FEE);

        vm.startBroadcast(deployerPrivateKey);

        console2.log("Deploying to Polygon Amoy (Chain ID: %d)", AMOY_CHAIN_ID);
    ...
    function printDeploymentSummary() internal view {
        console2.log("\n");
        console2.log("================================================================");
        console2.log("           DEPLOYMENT SUMMARY - POLYGON AMOY                    ");
        console2.log("================================================================");
        console2.log("");
        ...
        console2.log("  Trust Wallet:              ", trustWallet);
        console2.log("  Mailbox:                   ", vm.envOr("HYPERLANE_MAILBOX", AMOY_MAILBOX));
        console2.log("");
    }
}
